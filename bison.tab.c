...
#line 113 "bison.tab.c" /* yacc.c:337  */
# ifndef YY_NULLPTR
...
#line 194 "bison.tab.c" /* yacc.c:352  */
};
...
static const yytype_uint8 yyrline[] =
{
     ...
     108,   112,   113,   117,   118,   119,   120,   124,   125,   126,
...
{
  "$end", "error", "$undefined", "R_BEGIN", "R_END", "R_VAR", "R_INT",
  "R_FLOAT", "R_IF", "R_IFELSE", "R_WHILE", "R_READ", "R_PRINT",
  "S_SEMICOLON", "S_COLON", "S_ASSIGN", "S_PLUS", "S_MINUS", "S_ASTERISK",
  "S_SLASH", "S_PARENTL", "S_PARENTR", "S_NEGATIVE", "S_LESS", "S_GREATER",
  "S_EQUALS", "S_LTE", "S_GTE", "V_ID", "V_NUMINT", "V_NUMFLOAT",
  "$accept", "prog", "opt_decls", "decls", "dec", "tipo", "opt_stmts",
  "stmt_lst", "stmt", "expression", "expr", "term", "factor", "relop",
  "signo", YY_NULLPTR
};
#endif
...
{
       8,    -9,    27,    31,   -52,    38,    39,   -52,    -2,     8,
      -4,    -2,    32,    34,    35,    28,    13,    42,    54,   -52,
      46,   -52,   -52,   -52,   -52,    56,    13,    13,    13,   -52,
      13,   -52,   -52,   -52,   -52,     1,     6,   -52,    18,    13,
     -52,    -2,   -52,    40,     5,    41,    43,    23,    18,    18,
      18,    18,     6,     1,   -52,    -2,   -52,   -52,   -52,   -52,
     -52,    13,    -2,    -2,   -52,     6,     6,   -52,   -52,   -52,
       1,    -2,   -52,   -52
};
...
{
       4,     0,     0,     0,     3,     6,     0,     1,    11,     0,
       0,    11,     0,     0,     0,     0,     0,     0,     0,    10,
      13,     5,     8,     9,     7,     0,     0,     0,     0,    18,
       0,    39,    31,    32,    33,    19,    26,    29,     0,     0,
       2,     0,    20,     0,    21,     0,     0,     0,     0,     0,
       0,     0,    25,    14,    12,     0,    34,    35,    36,    37,
      38,     0,     0,     0,    30,    23,    24,    27,    28,    15,
      22,     0,    17,    16
};
...
{
      35,    11,    22,    23,    69,    52,    12,    13,    14,    15,
      16,    71,    72,     1,    47,    65,    66,    48,    49,     6,
      73,    48,    49,    53,    50,    51,    17,     7,    56,    57,
      58,    59,    60,    30,     8,    31,    45,    46,    30,    48,
      49,    32,    33,    34,    64,    70,    32,    33,    34,    67,
      68,     9,    26,    10,    27,    28,    29,    39,    40,    41,
      42,    55,    62,    25,    63,    54,    21
};

static const yytype_uint8 yycheck[] =
{
      16,     3,     6,     7,    55,    38,     8,     9,    10,    11,
      12,    62,    63,     5,    30,    48,    49,    16,    17,    28,
      71,    16,    17,    39,    18,    19,    28,     0,    23,    24,
      25,    26,    27,    20,     3,    22,    27,    28,    20,    16,
      17,    28,    29,    30,    21,    61,    28,    29,    30,    50,
      51,    13,    20,    14,    20,    20,    28,    15,     4,    13,
       4,    21,    21,    11,    21,    41,     9
};
...
{
       0,     5,    32,    33,    34,    35,    28,     0,     3,    13,
      14,     3,     8,     9,    10,    11,    12,    28,    37,    38,
      39,    34,     6,     7,    36,    37,    20,    20,    20,    28,
      20,    22,    28,    29,    30,    41,    42,    43,    45,    15,
       4,    13,     4,    40,    41,    40,    40,    41,    16,    17,
      18,    19,    42,    41,    38,    21,    23,    24,    25,    26,
      27,    44,    21,    21,    21,    42,    42,    43,    43,    39,
      41,    39,    39,    39
};
...
#line 1328 "bison.tab.c" /* yacc.c:1652  */
      default: break;
    }
